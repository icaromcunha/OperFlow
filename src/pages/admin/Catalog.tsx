    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-black text-text-primary tracking-tight">Catálogo Global</h1>
          <p className="text-text-secondary font-medium">Monitoramento de SKUs e estoque em todos os canais</p>
        </div>
        <button className="bg-brand-orange hover:bg-brand-orange/90 text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-brand-orange/20">
        ...
        <div className="p-6 border-b border-border-main flex flex-col md:flex-row gap-4 bg-white/5">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2.5 bg-bg-card border border-border-main rounded-xl text-sm focus:ring-2 focus:ring-brand-purple transition-all text-text-primary placeholder:text-text-secondary/50"
            />
          </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="font-bold text-text-primary">{p.sku}</span>
                        <span className="text-xs text-text-secondary">ID: #PRD-{p.id}</span>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm font-medium text-text-primary">{p.cliente_nome}</span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-text-primary">124 un.</span>
                      <span className="text-[10px] text-emerald-500 font-bold uppercase tracking-wider">Em Dia</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex gap-1.5">
                      <div className="size-7 rounded-lg bg-white border border-border-main flex items-center justify-center overflow-hidden" title="Mercado Livre">
                      ...
                      <div className="size-7 rounded-lg bg-white border border-border-main flex items-center justify-center overflow-hidden" title="Amazon">
                      ...
                      <div className="size-7 rounded-lg bg-white border border-border-main flex items-center justify-center overflow-hidden" title="Shopee">
